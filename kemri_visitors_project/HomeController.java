...
public class HomeController implements Initializable {
    ...
    {
        GridPane titles = getGridPane("Number", "Visitor ID",
                        "Visitor name",
                        "Visitor phone",
                        "Visitor`s origin",
    ...
    private void getReport(String date)
    {
        try
        {
            ...
            while( result.next() )
            {
                reportList.add( getGridPane( "" + (number + 1), result.getString(1),
                        result.getString(2),
                        result.getString(3),
                        result.getString(4),
                        result.getString(5),
    ...
    private GridPane getGridPane(String v_Num, String v_id, String v_name, String v_phone, String v_origin, String v_destination, String v_reason, String v_time_in, String v_time_out)
    {
